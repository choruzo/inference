...
WEB_SEARCH_FALLBACK = os.getenv("WEB_SEARCH_FALLBACK", "tavily").strip().lower()
WEB_SEARCH_MIN_RESULTS = int(os.getenv("WEB_SEARCH_MIN_RESULTS", "3"))
...
WEB_MAX_REDIRECTS = int(os.getenv("WEB_MAX_REDIRECTS", "5"))
WEB_FETCH_RESULTS = int(os.getenv("WEB_FETCH_RESULTS", "3"))
WEB_FETCH_MAX_CHARS = int(os.getenv("WEB_FETCH_MAX_CHARS", "20000"))
WEB_RETRY_ATTEMPTS = int(os.getenv("WEB_RETRY_ATTEMPTS", "2"))
WEB_RETRY_BACKOFF = float(os.getenv("WEB_RETRY_BACKOFF", "0.5"))
WEB_USER_AGENT = os.getenv("WEB_USER_AGENT", "AgenticLocal/1.0 (+http://localhost:8000)")
